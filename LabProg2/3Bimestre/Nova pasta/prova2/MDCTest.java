...
public class MDCTest
{
    ...
    public void proximoPrimoTest(){
        ...
        assertEquals(new Integer(13), MDC.primoProximo(13));
        assertEquals(new Integer(17), MDC.primoProximo(14));
        assertEquals(new Integer(17), MDC.primoProximo(15));
        assertEquals(new Integer(5490), MDC.primoProximo(5501));
    }
    ...
    public void calcularMDCTest(){
        ...
        assertEquals(new Integer(11), MDC.calcularMDC(8573, 7777));
    }
